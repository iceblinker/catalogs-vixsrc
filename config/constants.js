...
const SPECIAL_GENRE_CONFIG = {
    ...
    'Virus': {
        keywords: ['virus', 'pandemic', 'epidemic', 'outbreak', 'infection', 'disease', 'plague', 'ebola', 'lethal virus', 'zombie', 'epidemia', 'body horror', 'biological weapon', 'bacteria', 'mutation', 'contagion', 'vaccine', 'quarantine', 'survival', 'bioweapon', 'pathogen'],
        minRating: 6.0,
...
const MOVIE_GENRES = [
    "Novità", "Trending", "Azione", "Avventura", "Animazione", "Animal Terror",
    ...
    "Virus", "Western", "Asian Drama", "European Drama", "Korean"
];

const PROVIDER_MOVIE_GENRES = [
    "Azione", "Avventura", "Animazione", "Animal Terror", "Apocalypse",
    "Commedia", "Crime", "Documentario", "Dramma", "Dystopia", "Famiglia",
    "Fantascienza", "Fantasy", "Guerra", "Storia", "Horror", "Musica",
    "Mistero", "Romance", "Supernatural", "Thriller", "Virus", "Western", "Korean"
];
...
const SERIES_GENRES = [
    ...
    "War & Politics", "Western", "Virus", "Medical Drama", "Asian Drama", "European Drama", "Korean"
];
...
const PROVIDER_SERIES_GENRES = [
    ...
    "War & Politics", "Western", "Medical Drama", "Korean"
];
...
const SERIETV_COLLECTIONS_GENRES = [
    ...
    "Cinema TV", "Thriller", "Guerra", "Western", "Animal Terror",
    "Virus", "Dystopia", "Apocalypse", "Supernatural"
];

const COLLEZIONI_POPOLARI_GENRES = [
    "Recenti", "Azione", "Avventura", "Animal Terror", "Animazione",
    ...
    "Supernatural", "Thriller", "Virus", "Western", "Asian Drama", "European Drama", "Korean"
];

const KEYWORD_CATALOGS = {
    animal_horror: {
        name: 'Animal Terror', keywords: ['shark', 'animal attack', 'killer dog', 'piranha', 'crocodile', 'anaconda', 'wolf', 'bear', 'insect', "birds", "mutant animal", 'animal horror', 'killer animal', 'genetically mutated', 'spiders',
    ...
    virus_catalog: { name: 'Virus & Disease', keywords: ['virus', 'pandemic', 'epidemic', 'outbreak', 'infection', 'disease', 'plague', 'ebola', 'zombie', 'undead', 'bacteria', 'mutation', 'contagion', 'vaccine', 'quarantine', 'survival', 'bioweapon', 'pathogen'], minRating: 6.0, includeMovies: true, includeTV: true },
    ...
    apocalypse_catalog: { name: 'Apocalypse', keywords: ['post-apocalyptic', 'apocalypse', 'fine del mondo', 'nuclear war', 'global catastrophe', 'end of the world', 'apocolyptic', 'dystopia', 'survival', 'societal collapse', 'wasteland', 'bunker', 'shelter', 'collapse', 'extinction', 'aftermath'], minRating: 6.0, includeMovies: true, includeTV: true },
